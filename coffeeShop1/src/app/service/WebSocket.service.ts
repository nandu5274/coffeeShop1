...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Cleans up the WebSocket service by removing event listeners for
 * 'offline' and 'online' network events to prevent memory leaks.
 * Ensures that the WebSocket connection is properly closed when
 * the service is destroyed.
 */

/*******  95d84c4a-2402-46b2-b138-db241865e369  *******/
  ngOnDestroy() {
