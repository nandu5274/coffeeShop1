...
@Component({
  selector: 'app-counter-cap',
  templateUrl: './counter-cap.component.html',
  styleUrls: ['./counter-cap.component.scss']
})
export class CounterCapComponent implements AfterViewInit {
  messages: string[] = [];
  Status: any = ""
  loggedIn: any = false;
  pageType: any = "cap";
